...
export default function Row({ initLength, initFilled, rowIndex, initialTurn, changeTurn, initBoard, handleMove, initImageBoard, updateImgBoard, initShowModal, setTransformPawn, setTimelineMove }) {
